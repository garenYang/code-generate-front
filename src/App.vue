  ...
  <el-container class="wrapper">
    <el-header class="header">
      ...
      <div class="header-title">
        <h2 align="left" style="color:#FFFFFF;margin: 10px 0;">DEVP辅助开发平台</h2>
      </div>
    ...
    <el-container>
      ...
      <el-aside class="menu">
        <el-menu :router="true">
          ...
          <el-menu-item index="/projectGroup" :class="{'is-active': isRouteIndexOf('/projectGroup')}">
            <i class="el-icon-s-opportunity" />
            <span slot="title">项目管理</span>
          </el-menu-item>
          <el-menu-item index="/prd" :class="{'is-active': isRouteIndexOf('/prd')}">
            <i class="el-icon-s-opportunity" />
            <span slot="title">需求管理</span>
          </el-menu-item>
          <el-menu-item index="/fsd" :class="{'is-active': isRouteIndexOf('/fsd')}">
            <i class="el-icon-s-opportunity" />
