  ...
  <div class="entityList">
    ...
    <el-row type="flex" align="middle" :gutter="20" style="padding:10px 0;">
      ...
      <el-col :span="18" style="text-align: right;">
        <el-form :inline="true" :model="queryForm" class="entity-query-form-inline">
          <el-form-item>
            <el-select placeholder="请选择项目" v-model="queryForm.projectId" @change="handleQuery">
              <el-option
