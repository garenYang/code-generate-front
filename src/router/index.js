...
import treeForm from '@/views/chart/tree/form.vue'
...
import Prd from '@/views/prd/index.vue'
// import PrdTable from '@/views/prd/list.vue'
import PrdList from '@/views/prd/prdList.vue'
import Fsd from '@/views/fsd/index.vue'
import FsdTable from '@/views/fsd/list.vue'
import ProjectGroup from '@/views/projectGroup/index.vue'
import ProjectGroupTable from '@/views/projectGroup/list.vue'
